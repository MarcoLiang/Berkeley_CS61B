...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    // double d = ((double)table.collisions()) / table.buckets();
    System.out.println("Report collisions: "+table.collisions()+"/"+table.buckets() + " = " + ((double)table.collisions()) / table.buckets());
  }
